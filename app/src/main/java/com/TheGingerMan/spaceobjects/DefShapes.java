...
public class DefShapes {
    ...
    public static SpacialObject TRIANGLE(double width, double height) {
        ...
        ArrayList<Face> triFaces;
        SpacialObject tri = new SpacialObject(new Pivot(new Vector(0, 0, 0)));;
        ...
        triVertices.add(new Vertex(0, x2, 0));//0
        triVertices.add(new Vertex(-x, -x, x));//1
        triVertices.add(new Vertex(-x, -x, -x));//2
        triVertices.add(new Vertex(x, -x, -x));//3
        triVertices.add(new Vertex(x, -x, x));//4
        ...
        f = new Face(Color.BLUE);          //bottom
        f.vertices.add(triVertices.get(1));
        f.vertices.add(triVertices.get(2));
        f.vertices.add(triVertices.get(3));
        f.vertices.add(triVertices.get(4));

        tri.faces.add(f);

        f = new Face(Color.RED);
        f.vertices.add(triVertices.get(0));
        f.vertices.add(triVertices.get(1));
        f.vertices.add(triVertices.get(2));
